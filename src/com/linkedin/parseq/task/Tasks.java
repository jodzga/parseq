...
public class Tasks
{
   ...
   * successfully, you can use {@link com.linkedin.parseq.task.ParTask#get()} to
   * get a list of the results. If at least one task failed, then this task will
   * also be marked as failed. Use {@link com.linkedin.parseq.task.ParTask#getTasks()}
   * or {@link com.linkedin.parseq.task.ParTask#getSuccessful()} to get results in
   * this case.
   */
   ...
   * {@link com.linkedin.parseq.task.ParTask#get()} to get a list of the results. If
   * at least one task failed, then this task will also be marked as failed. Use
   * {@link com.linkedin.parseq.task.ParTask#getTasks()} or
   * {@link com.linkedin.parseq.task.ParTask#getSuccessful()} to get results in this
   * case.
   *
